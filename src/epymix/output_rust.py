...
from epyland.f_configuration import f_configuration
from epyland.SEIR_ERIN import SEIR ## SEIR fonction principale
from epyland.f_dispersion_gradient import dispersion_kernel_rust, dispersion_kernel_septo
from epyland.f_growth_companion import growth_pois
...
# inoc_init_abs = 500000  # 500000 %% spores initially present in reservoir P
# ng_ext0_abs = int(20000*delta_t/delta_t0) # 20000 %% spores coming from a cloud external to the landscape
#
# inoc_init = 0  # for the init_saison function in SEIR
# ng_ext0 = ng_ext0_abs
scenario_ino = 'initial_inoculum'; frac_inf = 1; inoc_init_abs = 500000; ng_ext0_abs = int(2000*delta_t/delta_t0)
